...
data = pd.read_csv(rf'C:\Users\genar\VSC code\CERN-Summer\RGA\{filename}.txt', 
                   sep=',', skiprows=27, header=None, engine='python', names=names)
...
# plt.savefig(f'{filename}.jpg', format='jpg', dpi=300, bbox_inches='tight')
plt.show()